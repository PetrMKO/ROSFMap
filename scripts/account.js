document.addEventListener('DOMContentLoaded', () => {
    ...
    const getUrlUserInfo = 'http://localhost:30300/user',
          getURLPoints = 'http://localhost:30300/points';
...
//Функции заполения полей информации о пользователе в зависимости от ответа от сервера
    function fillInfoFields(data) {
        ...
        fioField.innerText = `${data.name} ${data.surname} ${data.patronymic}`
        divisionField.innerText = data.division
        districtField.innerText = data.district
    }
